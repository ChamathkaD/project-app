...
@section('header')
    <h1 class="text-3xl font-bold tracking-tight text-gray-900">User Edit</h1>
@endsection
...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">          
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Edit New User</h2>
        </div>
